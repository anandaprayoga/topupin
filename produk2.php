...
<head>
    ...
    <title>TopUpin - Google Wallet </title>
...
<body>
    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="card-body card-chest">
                        <div class="d-flex flex-row justify-items-start">
                            <div class="product-icon">
                                <img src="./dist/img/googleplay.jpg" alt="">
                            </div>
                            ...
                            <div>
                                ...
                                <p class="product-name fs-lg-5">Google Play</p>
                            </div>
                        </div>
                        ...
                        <div class="product-desc mt-1" id="text-container">
                            <p class="p-0 m-0"><strong><em>**Ini hanya berlaku untuk akun Google Play yang terdaftar di wilayahnya.**</em></strong></p>
                                <p class="mt-3">Ingin beli voucher Google Play? Di TopUpin saja! TopUpin merupakan partner resmi bagi kamu yang ingin mendapatkan kode voucher Google Play untuk berbagai kebutuhan. Tersedia nominal mulai dari 1 USD sampai 100 USD.</p>
                                <p>Beli Google Wallet di TopUpin bisa dilakukan via Visa dan MasterCard. Top up Google Wallet juga bisa dilakukan tanpa harus mendaftar, login dan tanpa ribet aktifasi.</p>
            ...
            <button type="submit" id="checkout-button" onclick="window.location.href='https://www.codashop.com/id-id/kode-voucher-google-play'">Beli Sekarang!</button>
        </div>
    </div>
    <!-- /Content -->
