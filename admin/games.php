	...
	if ($tipe_file == "image/jpeg" || $tipe_file == "image/png") {
		if ($ukuran_file <= 5000000) {
			if (move_uploaded_file($tmp_file, $path)) {
				...
				$query = "INSERT INTO games (nama, gambar) VALUES('$nama','$pathdb')";
				...
				if ($sql) {
					...
					echo "<br><meta http-equiv='refresh' content='5; URL=games.php'> You will be redirected to the form in 5 seconds";
				} else {
					// Jika Gagal, Lakukan :
...
<head>
	...
	<title>TopUpin - Kelola Staff</title>
...
<body>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-center mb-4">
									<h4 class="d-inline">Daftar Games</h4>
								...
								<div class="data-tables datatable-dark">
									<table id="dataTable3" class="display" style="width:100%">
										...
										<tbody>
											<?php
											$brgs = mysqli_query($koneksi, "SELECT * FROM games ORDER BY id_game ASC");
											$no = 1;
											...
											?>
												<tr>
													...
													<td>
														<a href="avascript:void(0);" id="#edit" class="edit btn btn-primary btn-xs" data-id="<?= $p['id_game'] ?>" data-nama="<?= $p['nama'] ?>" data-gambar="<?= $p['gambar'] ?>" data-developer = "<? $p['developer']?>"><i class="fas fa-edit"></i></a>
														<!-- <a href="action.php?id=<?= $p['id_admin'] ?>" data-toggle="modal" data-target="#editModal"><i class="fas fa-edit"></i></a> -->

														<a href="action.php?act=hapusgames&id=<?php echo $p['id_game'] ?>" name="hapusgames" class="btn btn-danger btn-xs"><i class="fas fa-trash"></i></a>
													</td>
												</tr>
											<?php
											}
	...
	<!-- Modal Input Users -->
	<?php include './docs/modal_tambahGame.php'; ?>
    <!-- //Modal Input Users -->
				...
				<div class="modal-body">
					<form action="games.php" method="post" enctype="multipart/form-data">
						...
						<div class="form-group mb-4">
							...
							<input name="developer" type="text" class="form-control" required autofocus>
						</div>
						<div class="form-group mb-4">
							<label>Gambar</label>
