											...
											?>
												<tr>
                                                    ...
                                                    <a href="avascript:void(0);" id="#edit" class="edit btn btn-primary btn-xs" data-id="<?= $p['id_game'] ?>" data-nama="<?= $p['nama'] ?>" data-gambar="<?= $p['gambar'] ?>" data-developer = "<? $p['developer']?>"><i class="fas fa-edit"></i></a>
														<!-- <a href="action.php?id=<?= $brgs['id_game'] ?>" data-toggle="modal" data-target="#editModal"><i class="fas fa-edit"></i></a> -->

														<a href="produk.php?act=hapus&id=<?= $brgs['id_game'] ?>" name="hapusproduk" class="btn btn-danger btn-xs"><i class="fas fa-trash"></i></a>
													</td>
												</tr>
											<?php
											}
