...
<head>
    ...
    <title>TopUpin - Kelola Produk</title>
...
<body>
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $admin = mysqli_query($koneksi, "SELECT * FROM product ORDER BY id_product ASC");
                                            $no = 1;
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $gm['amount'] ?></td>
                                                    <td>
                                                        <a href="javascript:void(0);" id="#edit" class="edit btn btn-primary btn-xs" data-id="<?= $gm['id_product'] ?>" data-nama="<?= $gm['name'] ?>" data-idgame="<?= $gm['id_game'] ?>" data-harga="<?= $gm['amount'] ?>"><i class="fas fa-edit"></i></a>
                                                        <!-- <a href="action.php?id=<?= $gm['id_admin'] ?>" data-toggle="modal" data-target="#editModal"><i class="fas fa-edit"></i></a> -->

                                                        <a href="action.php?act=hapusproduct&id=<?= $gm['id_product'] ?>" name="hapusproduct" class="btn btn-danger btn-xs"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
    ...
    <!-- Modal Input Users -->
    <?php include './docs/modal_tambahProduk.php'; ?>
    <!-- //Modal Input Users -->

    <!-- Modal Edit Users -->
    <?php include './docs/modal_editProduct.php'; ?>
    <!-- //Modal Edit Users -->
